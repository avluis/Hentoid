...
Java_me_devsaki_hentoid_gpu_1render_NativeLib_00024Companion_YUVtoRBGA(JNIEnv *env, jobject obj,
                                                                       jbyteArray yuv420sp,
...
JNIEXPORT void JNICALL
Java_me_devsaki_hentoid_gpu_1render_NativeLib_00024Companion_YUVtoARBG(JNIEnv *env, jobject obj,
                                                                       jbyteArray yuv420sp,
                                                                       jint width, jint height,
                                                                       jintArray rgbOut) {
    int sz;
