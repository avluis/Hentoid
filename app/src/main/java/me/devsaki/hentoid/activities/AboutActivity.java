...
public class AboutActivity extends BaseActivity {
    ...
    private void populateLinks(final Intent intent) {
        ...
        TextView tvCommunity = findViewById(R.id.tv_community);
        ...
        TextView tvDiscord = findViewById(R.id.tv_discord);
        ...
        TextView tvReddit = findViewById(R.id.tv_reddit);
    ...
    private void attachBuildNotes() {
        ...
        TextView tvAboutNotes = findViewById(R.id.tv_about_notes);
