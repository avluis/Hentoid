...
import me.devsaki.hentoid.util.DuplicateHelper.calcPhash
import me.devsaki.hentoid.util.DuplicateHelper.getCoverBitmapFromStream
...
abstract class BaseWebActivity : BaseActivity(), CustomWebViewClient.CustomWebActivity,
    ...
    private fun getStartUrl(): String? {
        ...
        return if (welcomePage != null) welcomePage.url else getStartSite().url
    ...
    private fun doSearchForExtraImages(
        ...
        val parser = ContentParserFactory.getInstance().getImageListParser(onlineContent)
