...
public class ViewerBottomImageFragment extends BottomSheetDialogFragment {
    ...
    private void onImagesChanged(List<ImageFile> images) {
        ...
        if (isArchive) {
            ...
            filePath = FileHelper.getFullPathFromUri(requireContext(), Uri.parse(archiveUri), false) + fileName;
        } else {
            filePath = FileHelper.getFullPathFromUri(requireContext(), Uri.parse(image.getFileUri()), false);
        }
